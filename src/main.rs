...
// pub mod bindings;
mod utils;
// use crate::utils::{find_burn_key, generate_burn_address, input_file,RapidsnarkProof,RapidsnarkOutput};
use crate::utils::{
    RapidsnarkOutput, RapidsnarkProof, find_burn_key, generate_burn_address, input_file,
};
